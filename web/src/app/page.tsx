...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      {/* Comparaison halal vs complet */}
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <Link
          href="/comparaison"
          className="cursor-pointer group glass-card rounded-2xl p-7 block border-l-4 border-l-[var(--color-halal)]"
        >
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-lg font-bold text-[var(--color-navy)]">
              Halal vs indice complet
            </h3>
            <span className="text-sm text-[var(--color-muted-foreground)] group-hover:text-[var(--color-gold)] transition-colors duration-200">
              Voir l&apos;analyse →
            </span>
          ...
          <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed">
            Concentration sectorielle, poids des top 10, metriques cles :
            comparez la version halal a l&apos;indice d&apos;origine.
          </p>
        </Link>
      </section>

      {/* Backtest — performance historique */}
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <Link
          href="/backtest"
        ...
        >
          ...
          <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed">
            Et si vous aviez investi halal il y a 5 ans ? Comparez la
            performance reelle des indices halal vs les indices complets.
          </p>
        </Link>
      </section>
