...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "NASDAQ 100 Halal : 65 actions, S&P 500 Halal : 221 actions. Screening AAOIFI, simulateur de portefeuille, backtest historique. Gratuit et open-source.",
  ...
  twitter: {
    ...
    title: "MuslimFinance — Indices NASDAQ 100 & S&P 500 halal",
    description:
      "NASDAQ 100 Halal : 65 actions, S&P 500 Halal : 221 actions. Screening AAOIFI, backtest historique. Gratuit et open-source.",
    images: ["/og-image.png"],
  },
};
