...
export const metadata: Metadata = {
  title: "NASDAQ 100 Halal — Composition & Portfolio Simulator",
  description: `${data.stats.included} stocks in the NASDAQ 100 pass the AAOIFI screening. The other ${data.stats.excluded} are removed. Enter an amount to see your allocation. Data from Zoya.finance, not financial advice.`,
};
...
const jsonLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Which NASDAQ 100 stocks are halal?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": `Out of ${stats.total_nasdaq100} stocks in the NASDAQ 100, ${stats.halal_count} are compliant with the AAOIFI standard (source: Zoya.finance). The other ${stats.excluded} are excluded (non-compliant or doubtful). Weights are redistributed pro-rata. See the full composition at muslimfinance.net/en/nasdaq-halal.`,
      },
    },
    {
      "@type": "Question",
      "name": "How to invest in a halal NASDAQ 100?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Why are Microsoft, Amazon and Meta excluded from the Halal NASDAQ 100?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "These companies are classified as 'Doubtful' by Zoya.finance under the AAOIFI standard, due to borderline financial ratios (interest income, debt levels). In our strict approach, doubtful stocks are excluded.",
      },
    },
  ],
};

export default function NasdaqHalalEn() {
  return (
      ...
      <header className="relative overflow-hidden border-b border-[var(--border)]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pt-16 pb-12">
          ...
          <div className="mt-6 max-w-2xl space-y-3 text-[0.95rem] text-[var(--color-muted-foreground)] leading-[1.7]">
            <p>
              <strong className="text-[var(--foreground)]">What is the NASDAQ 100?</strong>{" "}
              An index of the 100 largest tech companies listed in the US:
              Apple, Nvidia, Google, Amazon, Tesla... Created in 1985, it has
              returned roughly <strong className="text-[var(--foreground)]">13% per year</strong> on
              average historically (~16% over the last 10 years).
            </p>
            <p>
              <strong className="text-[var(--foreground)]">The problem:</strong>{" "}
              some of these companies don&apos;t pass the Islamic finance filter
              (too much debt, interest income, prohibited activities). We
              screened them all: out of {stats.total_nasdaq100},{" "}
              <strong className="text-[var(--color-halal)]">{stats.included} are compliant</strong>.
              The other {stats.excluded} are removed. Weights are recalculated.
            </p>
            <p>
              Enter an amount below to see exactly how much to allocate to each
              stock. You can export the result as CSV.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="glass-card rounded-2xl p-6">
            ...
            <p className="mt-1 text-sm text-[var(--color-muted-foreground)]/50">
              out of {stats.total_nasdaq100} in the NASDAQ 100
            </p>
          </div>
          <div className="glass-card rounded-2xl p-6">
            <p className="text-sm font-medium text-[var(--color-muted-foreground)]">
        ...
        <section>
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-[var(--color-muted-foreground)]">
              ...
              {stats.excluded_weight_pct}% of the original NASDAQ 100
            </p>
          </div>
