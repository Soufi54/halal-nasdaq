...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "NASDAQ 100 Halal: 66 stocks, S&P 500 Halal: 228 stocks. AAOIFI screening, portfolio simulator, historical backtest. Free and open-source.",
  ...
  twitter: {
    ...
    title: "MuslimFinance — Halal NASDAQ 100 & S&P 500 Index",
    description:
      "NASDAQ 100 Halal: 66 stocks, S&P 500 Halal: 228 stocks. AAOIFI screening, historical backtest. Free and open-source.",
